...
document.write("<br>" + 'Повинно повернути 24:', res + "<br>" + "<br>" +'Змінив const result на const res бо помилку вивалював що вже  використовував result, і не зрозумів для чогов в кожному завдані export { ..... } закоментував бо помилку видавало ' + "<br>")
/*
