...
function modifyFunction(originalFunction, multiplier) {
  return function(modnum)  {
    const result = originalFunction(modnum)
    return result * multiplier;
  }
}
// Приклад використання
const modifiedFunc = modifyFunction(originalFunction, 4)
...
document.write("<br>" + 'Original function output for 4:', originalFunction(4) + "<br>" + 'Modified function output for 4:', modifiedFunc(4) + "<br>")
